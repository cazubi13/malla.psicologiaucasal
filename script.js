...
document.addEventListener("DOMContentLoaded", () => {
    // La lista COMPLETA de materias con las correcciones aplicadas
    const materias = [
        // 1er Año
        ...
        { codigo: "07 0280", nombre: "Psicología del Deporte", anio: 3, semestre: 1, esAnual: false, 
            cursar: [{materia: "07 0020", estado: "Aprob."}, {materia: "07 0150", estado: "Reg."}, {materia: "20 0100", estado: "Reg."}], 
            rendir: [{materia: "20 0100", estado: "Aprob."}, {materia: "07 0150", estado: "Aprob."}] // <-- CORRECCIÓN AQUÍ: Se añadió 07 0150 como Aprobada para rendir.
        },
        { codigo: "07 1310", nombre: "Psicopatología Infanto Juvenil", anio: 3, semestre: 1, esAnual: false, 
            cursar: [{materia: "07 0260", estado: "Aprob."}, {materia: "07 0020", estado: "Aprob."}, {materia: "07 0150", estado: "Aprob."}, {materia: "07 0080", estado: "Reg."}], // <-- CORRECCIÓN AQUÍ: 07 0150 cambió de "Reg." a "Aprob."
            rendir: [{materia: "07 0150", estado: "Aprob."}, {materia: "07 0080", estado: "Aprob."}] 
        },
    ...
    // El resto del código que maneja la lógica no necesita cambios.
    // Pégalo tal como estaba.
    ...
    function cambiarEstadoMateria(codigo) { /* ...código sin cambios... */ }
    function crearMalla() { /* ...código sin cambios... */ }
...
function marcarProgresoHasta() { /* ...código sin cambios... */ }
function limpiarProgreso() { /* ...código sin cambios... */ }               columna.appendChild(divMateria);
            }
        });
